...
Damera Sai Sreeja – Frontend Design, Cart Functionality, Integration

Gowru Sujitha – Backend Development, API Design

B Yoshik – Database Design, Admin Module, Testing

Yaswanth Gunakala – Order Placement, Checkout Flow

Kandati Vandana – UI Enhancements, Dashboard Charts, Testing
...
✨ Built with ❤️ by Damera Sai Sreeja, Gowru Sujitha, B Yoshik, Yaswath Gunkala, Kandati Vandana ✨
